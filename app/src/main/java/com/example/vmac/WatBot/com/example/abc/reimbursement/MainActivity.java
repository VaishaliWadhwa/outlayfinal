...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    com.example.vmac.WatBot.com.example.abc.reimbursement.BillCursorAdapter mCursorAdapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reimbursement_main);
        ...
        mCursorAdapter = new com.example.vmac.WatBot.com.example.abc.reimbursement.BillCursorAdapter(this, null);
        ...
        expenseListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity.this, com.example.vmac.WatBot.com.example.abc.reimbursement.ExpenseReport.class);
...
//        String selection = BillContract.BillEntry.COLUMN_EXPENSE_CAT + "= 'NoCategory' AND "+BillContract.BillEntry.USER +"= "+user;
//
//
...
//                null);                  // Default sort order
        String selection = "category = ? AND user = ?";
        String selectionArgs [] = new String[] { "NoCategory", user };
    ...
    public void openDialog(){
        ...
        editorExpenseDialog.setArguments(bundle);
